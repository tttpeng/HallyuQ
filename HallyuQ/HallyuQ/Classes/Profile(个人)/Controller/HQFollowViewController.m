...
@interface HQFollowViewController ()<HQBaseBarViewDelegate,UITableViewDataSource,UITableViewDelegate>
...
@implementation HQFollowViewController
...
- (void)getFansData
{
    ...
    NSDictionary *paramas = @{@"user_id":@"146",@"type":@"2"};
