...
@interface ZYStarViewController ()
...
@implementation ZYStarViewController
...
//        
//        if (newses.count >= kImagesCount) {
//            for (int i = 0; i < kImagesCount; i++) {
//                [self.images addObject:newses[i][@"image"]];
//                [self.titles addObject:newses[i][@"titile"]];
//            }
//        }
//        
