...
@interface HQHomeViewController ()<UITableViewDataSource,UITableViewDelegate>
...
- (void)viewDidLoad {
    ...
    self.tableView.backgroundColor = [UIColor colorWithRed:0.000 green:0.878 blue:0.529 alpha:1.000];
