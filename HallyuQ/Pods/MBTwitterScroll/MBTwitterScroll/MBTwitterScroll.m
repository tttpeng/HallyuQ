...
- (void) setupView:(UIImage*)backgroundImage avatarImage:(UIImage *)avatarImage titleString:(NSString *)titleString subtitleString:(NSString *)subtitleString buttonTitle:(NSString *)buttonTitle scrollHeight:(CGFloat)height type:(MBType)type {
    ...
    if (buttonTitle.length > 0) {
        headerButton = [[UIButton alloc] initWithFrame:CGRectMake(self.frame.size.width - 120, 120, 100, 30)];
        
        [headerButton setTitle:buttonTitle forState:UIControlStateNormal];
        [headerButton setTitle:@"已关注" forState:UIControlStateSelected];

        [headerButton setTitleColor:[UIColor colorWithRed:0.277 green:0.613 blue:0.928 alpha:1.000] forState:UIControlStateNormal];
        [headerButton setImage:[UIImage imageNamed:@"icn_follow_text_checked"] forState:UIControlStateSelected];
        [headerButton setImage:[UIImage imageNamed:@"icn_follow_text"] forState:UIControlStateNormal];
        [headerButton setBackgroundImage:[UIImage imageNamed:@"btn_following_default"] forState:UIControlStateSelected];
//        [headerButton setBackgroundImage:[UIImage imageNamed:@"btn_standard_default"] forState:UIControlStateNormal];
        ...
        headerButton.layer.borderColor = [UIColor colorWithRed:0.297 green:0.629 blue:0.930 alpha:1.000].CGColor;
...
- (void) recievedMBTwitterScrollButtonClicked:(UIButton *)button {
    [self.delegate recievedMBTwitterScrollButtonClickedWithButton:button];
}
